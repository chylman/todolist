...
export const createTaskAC = createAction<{title: string, id: string}>('tasks/createTask');
...
export const changeTaskTitleAC = createAction<{taskId: string, title: string, todolistId: string}>('tasks/changeTaskTitle')
...
export const tasksReducer = createReducer(initialState, (builder) => {
    builder
        ...
        .addCase(createTaskAC, (state, action) => {
            state[action.payload.id].unshift({title: action.payload.title, id: nanoid(), isDone: false});
        })
